            ...
            <div className="admin-login-card">
                ...
                <form className="login-form" onSubmit={handleLogin}>
                    ...
                    <div className="account-options">
                        ...
                        <div className="option-item">
                            <span className="option-text">Security Guard?</span>
                            <a href="/security-login" className="option-link" onClick={(e) => { e.preventDefault(); navigate('/security-login'); }}>Security Login</a>
                        </div>
                    </div>
                </form>
            </div>
